...
const ARCHETYPES = {
  CEO: {
    ...
    alts: [
      { name: 'Legend', house: 'Montblanc', desc: "Ne vous surprend pas. N'en a pas besoin. Se présente, livre, repart.", img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/legend.png', link: 'https://www.montblanc-bordeaux.fr/products/legend-eau-de-toilette-100-ml' },
      { name: 'Escentric 05', house: 'Escentric Molecules', desc: 'Frais et concentré comme votre nouvelle aventure professionnelle.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/escentric-05.png', link: 'https://www.escentric.com/en-eu/products/escentric-05-refill-30ml' },
      { name: 'Musky Oakmoss', house: 'Dossier', desc: "Pas encore là, mais sait exactement ce qu'il veut et y va.", img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/musky-oakmoss.png', link: 'https://dossier.eu/fr/products/musky-oakmoss' }
    ],
    ingredients: [
      {
        name: 'Genévrier',
  ...
  JAPAN: {
    ...
    main: {
      ...
      img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/dirty-hinoki.png',
      link: 'https://hereticparfum.com/products/dirty-hinoki?variant=39270055346240'
    },
    alts: [
      { name: 'Tokyo', house: 'Gallivant', desc: "Chaque note à sa place. Rien d'ajouté. Rien de manquant.", img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/tokyo.png', link: 'https://50-ml.fr/gallivant-tokyo-eau-de-parfum' },
      { name: 'Shiso', house: 'Roger & Gallet', desc: 'Propre comme la pluie sur la pierre. Silencieux comme un choix déjà fait.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/shiso.png', link: 'https://fr.roger-gallet.com/p/RG1013011WW/rg1013011ww-shiso-eau-parfumee-bienfaisante-heritage-100-ml' },
      { name: 'New Zealand', house: 'Demeter', desc: "Assez loin de tout pour enfin s'entendre.", img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/new-zealand.png', link: 'https://demeterfragrance.com/products/new-zealand-cologne-spray' }
    ],
    ingredients: [
      {
        name: 'Thé Vert',
  ...
  HUG: {
    ...
    main: {
      ...
      img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/eau-duelle.png',
      link: 'https://www.diptyqueparis.com/fr_fr/p/eau-de-toilette-eau-duelle-100ml.html'
    },
    alts: [
      { name: 'You', house: 'Glossier', desc: "Sent comme quelqu'un qui se souvient comment vous prenez votre café.", img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/you-doux.png', link: 'https://www.glossier.com/fr-fr/products/glossier-you-doux' },
      { name: 'Baby Powder', house: 'Demeter', desc: 'Inconnu au début. Puis soudainement la seule chose qui semble juste.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/baby-powder.png', link: 'https://demeterfragrance.com/products/baby-powder-cologne-spray' },
      { name: 'By the Fireplace', house: 'Maison Margiela', desc: 'Nulle part où être. Personne pour qui jouer un rôle. Juste ça.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/by-the-fireplace.png', link: 'https://www.my-origines.com/fr/by-the-fireplace-59L14132.html' }
    ],
    ingredients: [
      {
        name: 'Benjoin',
  ...
  OFFGRID: {
    ...
    main: {
      ...
      img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/coven.png',
      link: 'https://www.niche-beauty.com/fr-fr/produits/andrea-maack-coven/844-023'
    },
    alts: [
      { name: 'Baikal Leather Intense', house: 'Nicolaï', desc: 'Assez froid pour se sentir vivant(e). Assez éloigné pour se sentir libre.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/baikal-leather.png', link: 'https://nicolaiparis.com/en/products/baikal-leather-intense-1' },
      { name: 'From the Garden', house: 'Maison Margiela', desc: 'De la terre sous les ongles. Le soleil dans le cou. Nulle part ailleurs à être.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/from-the-garden.png', link: 'https://www.my-origines.com/fr/from-the-garden-59L23139.html' },
      { name: 'Sandflowers', house: 'Montale', desc: 'Vent, sel, rien au calendrier. Enfin.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/sandflowers.png', link: 'https://montaleparfums.com/en/marine/70-376-sandflowers-argent.html' }
    ],
    ingredients: [
      {
        name: 'Noix Noire',
  ...
  OUTOFTIME: {
    ...
    main: {
      ...
      img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/gris-clair.png',
      link: 'https://sergelutens.fr/products/gris-clair-eau-de-parfum-spray'
    },
    alts: [
      { name: 'Aromatics Elixir', house: 'Clinique', desc: "D'une époque où l'excès était une philosophie. Vous comprenez pourquoi.", img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/aromatics-elixir.png', link: 'https://www.clinique.fr/product/aromatics-elixir-eau-de-parfum-spray?size=45_ml' },
      { name: 'Encre Noire', house: 'Lalique', desc: 'Sombre, délibéré, et complètement indifférent à votre réaction.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/encre-noire.png', link: 'https://www.notino.fr/lalique/encre-noire-for-men-eau-de-toilette-pour-homme/p-62724/' },
      { name: 'Grey Flannel', house: 'Geoffrey Beene', desc: 'Sent comme rester quand tout le monde est sorti. Et avoir eu raison.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/grey-flannel.png', link: 'https://www.my-origines.com/fr/grey-flannel-09118624.html' }
    ],
    ingredients: [
      {
        name: 'Violette',
  ...
  SUMMER: {
    ...
    main: {
      ...
      img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/solo-vulcan.png',
      link: 'https://www.perfumesloewe.com/int/en_FR/men/loewe-solo/loewe-solo-vulcan-edp-100ml-LW80620.html'
    },
    alts: [
      { name: 'Avgoustos', house: 'Parfums de Marly', desc: 'Chaleur, sel, le temps qui ralentit exprès.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/avgoustos.png', link: 'https://www.korres.fr/products/eau-de-toilette-avgoustos' },
      { name: 'Bois de Yuzu', house: 'Karl Lagerfeld', desc: 'La nuit est jeune et la conversation aussi.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/bois-de-yuzu.png', link: 'https://www.notino.fr/karl-lagerfeld/bois-de-yuzu-eau-de-toilette-pour-homme/p-15791163/' },
      { name: 'Un Jardin sur le Nil', house: 'Hermès', desc: 'Se déplace comme vous. Léger, sans hâte, et pourtant partout à la fois.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/un-jardin-sur-le-nil.png', link: 'https://www.hermes.com/fr/fr/product/un-jardin-sur-le-nil-eau-de-toilette-V26993/' }
    ],
    ingredients: [
      {
        name: 'Tiaré',
  ...
  THERAPIST: {
    ...
    main: {
      ...
      img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/black-tea.png',
      link: 'https://www.jilsander.com/fr-fr/jil-sander-black-tea-100-ml/J65YX0006JFR001998.html'
    },
    alts: [
      { name: 'Geranio Imperiale', house: 'Culti Milano', desc: 'Assez précis pour tout remarquer. Assez composé pour ne pas en mentionner la plupart.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/geranio-imperiale.png', link: 'https://www.notino.fr/culti/geranio-imperiale-aquae-di-profumo-eau-de-toilette-mixte/' },
      { name: '1472 La Divina Commedia', house: 'Histoires de Parfums', desc: "Sait exactement où ça se termine. C'est ce qui le rend sûr d'être près de lui.", img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/1472.png', link: 'https://www.notino.fr/histoires-de-parfums/1472-eau-de-parfum-mixte/p-16349773/' },
      { name: '702', house: 'Bon Parfumeur', desc: "Sent comme quelqu'un qui a déjà tout pensé pour que vous n'ayez pas à le faire.", img: 'https://res.cloudinary.com/dcefrxxav/image/upload/findmysmell/perfumes/702.png', link: 'https://www.bonparfumeur.com/fr/products/702-incense-lavender-and-cashmere-wood' }
    ],
    ingredients: [
      {
        name: 'Oud',
...
function buildBlock(key, arch) {
  ...
  const altsHTML = arch.alts.map(function(a) {
    return '<div class="fms-z4-item">' +
      '<img class="fms-z4-img" src="' + window.fmsTx(a.img, FMS_TX.bottleS) + '" alt="' + a.name + '" crossorigin="anonymous">' +
