...
function buildBlock(key, arch) {
  ...
  z5.querySelector('#fms-btn-telegram').addEventListener('click', function() {
    window.open('https://t.me/share/url?url=' + encodeURIComponent(SITE_URL) + '&text=' + encodeURIComponent(shareText), '_blank');
  });
  z5.querySelector('#fms-btn-copy').addEventListener('click', function() {
  ...
  if (typeof fmsDrawCard === 'function') setTimeout(function() { fmsDrawCard(canvas); }, 800);
}
