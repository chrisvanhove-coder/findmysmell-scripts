...
> **Полная выгрузка перед отказом от подписки — `EXPORT-2026-09-24.md`.**
> Там CMS-каталог, custom code французских и русских страниц и текст всех
> 75 страниц. Этот файл описывает только первую, частичную выгрузку.
