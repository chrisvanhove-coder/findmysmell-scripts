...
console.log('\nТеги ссылки-превью собраны из одного места');
{
  ...
  check('в превью результата идёт панчлайн, а не «You are ...»',
    result.includes('const shareTitle = punchLine || title'),
    'иначе в ссылке всплывёт текст, который заказчица просила убрать');
}
