// ============================================================
// SECTION 0 — S/R/P MATCHING ENGINE
// ============================================================
...
function getUserSRP() {
  ...
  // Skin behavior modifier:
  // If skin makes things sweeter, target one notch less sweet (skin adds it)
  // If skin makes things sharper/bitter, target one notch more sweet (skin strips it)
...
const ARCHETYPES = {
  ...
  JAPAN: {
    ...
    ingredients: [
      { name: 'Green Tea', desc: 'The smell of water just before it boils. Green, slightly bitter.', detail: 'It is not sweet. There\'s a slight bitterness underneath the green that keeps it from ever feeling soft or floral. It smells like focusing on something. A lot of brands use different types of teas from wulong to jasmine.\nIn perfumery green tea is used to add a clean, slightly cool quality that sits between fresh and herbal. Its molecules evaporate at medium speed, placing it in the heart of a fragrance \u2014 present but not loud. It\'s one of the few ingredients that smells exactly like what it is, which is rarer than it sounds. Has very different pairings depending on a perfume brief from citrusy to fruity.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/v1777885226/gree-tea_w4toim.jpg' },
      { name: 'Hinoki', desc: 'Warm water on cold hands.', detail: 'Woody, slightly citrusy, and clean in a way that feels ancient rather than clinical. Hinoki is Japanese cypress \u2014 the wood used in traditional bathhouses and temples. You may not have smelled it labeled as hinoki, but if you\'ve ever been in a high-end spa and noticed the wood smelling like something more than just wood, that was probably it.\nIn perfumery hinoki is used to add a warm, clean woodiness that doesn\'t feel heavy. Its molecules sit in the base and heart of a fragrance, evaporating slowly and leaving a quiet, mineral warmth on skin. Often paired with green tea, iris, or bergamot.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/v1777885236/Hinoki_kwtliy.jpg' },
      { name: 'Iris', desc: 'The beginning of something great.', detail: 'Powdery, slightly earthy, with a cool almost metallic edge underneath. Not a flower smell exactly, but more of a root, which is where the scent actually comes from. One of the most famous fragrances with this ingredient is Dior Homme.\nIn perfumery iris is one of the most expensive ingredients to produce. The root takes three years to mature before it can be processed. This is why it appears mostly in higher-end fragrances. Its molecules are heavy and slow, making it a base note that lingers on skin long after everything else has gone. It adds a cool, powdery depth that grounds a fragrance without warming it. Often paired with woods, tonka bean, musk, or other flowers.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/v1777885261/iris_zuvmbv.jpg' },
      { name: 'Elderflower', desc: 'A feeling of a good evening ahead.', detail: 'Delicate, slightly watery, with a soft green quality underneath the flower. Not sweet like rose or loud like jasmine, but more like the smell of something blooming in a wild garden. You know it from tonic water, from Japanese-style drinks, from high-end cocktails. It\'s the ingredient that makes a fragrance feel effortless.\nIn perfumery elderflower is used to add a light, airy floral quality without the heaviness that most flowers bring. Its molecules evaporate quickly, placing it in the top and heart of a fragrance: present at first, then gradually making way for what\'s underneath. It softens without sweetening. Often paired with fruits, lavender, or clean musks.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/v1777885270/hf_20260428_134353_f762a115-cdd0-4303-b66c-0079aef4b627_v56tww.png' },
      { name: 'Rice', desc: 'The smell of something simple done perfectly.', detail: 'Soft, powdery, and faintly sweet without being sugary. The smell of rice cooking is one of the most universally recognisable in the world. On skin it becomes something quieter and closer, almost like clean fabric. It is mostly used by modern brands including Kilian, Maison Margiela, d.grayi, Diptyque and others.\nIn perfumery rice is used to add a soft, powdery warmth that sits very close to the skin. This makes it one of the few ingredients that creates intimacy rather than presence. Often extracted as rice bran or rice milk in formulations. Paired with musk, iris, or light woods. It makes fragrances feel minimal but present.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/v1777885277/hf_20260428_140116_d0ea1402-bbc7-478b-929c-a066835069d8_gd3pzg.png' }
    ]
  },
  HUG: {
    you: 'You are',
  ...
  OFFGRID: {
    ...
    ingredients: [
      { name: 'Black Walnut', desc: 'Dark, slightly bitter, and completely unique.', detail: 'Rich, earthy, and faintly sharp with a raw, slightly tannic edge that sets it apart from regular walnut. Not a food smell, more like the woody shell. You might find it in artisan food shops, specialty skincare, or certain niche perfumes and candles.\nIn perfumery black walnut is used to add a dark, grounding earthiness that sits in the base of a fragrance. Its molecules are heavy and slow to evaporate, giving it staying power on skin. It adds a raw, slightly bitter depth that keeps fragrances from feeling polished or refined. Often paired with vetiver, smoke, or dark woods. Or as a gourmand twist with chocolate, vanilla or alcohol.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/v1777885496/hf_20260428_133100_047c96e8-8c61-45c4-a73c-65eb468d5730_bm12s4.png' },
      { name: 'Sage', desc: 'Dry, slightly peppery like the meditation itself.', detail: 'There\'s a smokiness underneath it that makes it feel wilder than most herbs. You know it from cooking, from smudge sticks, from certain skincare products. On skin it becomes drier and more mineral than you expect.\nIn perfumery sage is used to add a sharp, herbal clarity that feels outdoor and unpolished. Its molecules evaporate at medium speed, placing it in the heart of a fragrance. It\'s one of the few herbal ingredients that doesn\'t soften in a fragrance, it stays dry and slightly icy throughout. Often paired with citrus, herbals, earth notes, or smoke. Used by brands like YSL, Valentino, Dossier.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/v1777885503/sage_hame6q.jpg' },
      { name: 'Opoponax', desc: 'A fire that went out an hour ago but the wood is still warm.', detail: 'Sweet, warm spicy, and faintly smoky \u2014 myrrh is its close relative. It comes from a plant resin found in East Africa and the Middle East. You might know it from incense or from certain natural perfumes. It smells like something that was burning a long time ago and left its warmth in the walls. One of the most famous fragrances with this ingredient added is "Shalimar" by Guerlain.\nIn perfumery opoponax is used as a base note and fixative. Its heavy molecules evaporate slowly and extend everything around them. It adds a warm, smoky sweetness that doesn\'t feel gourmand. Often paired with woods.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/v1777885531/Opoponax1_qnzzdh.png' },
      { name: 'Pine', desc: 'Forest. Cold air. Hike.', detail: 'Sharp, resinous, and clean, but colder and more icy than the pine of Christmas candles. The real smell of pine is harder than most people expect. You know it from forests or from mountain air. Used by brands like Filippo Sorcinelli, Serge Lutens, Comme des Gar\u00e7ons, famous "Gypsy Water" by Byredo.\nIn perfumery pine is used to add a cold, outdoor sharpness that most ingredients can\'t achieve. Its molecules are light and volatile, making it a top note \u2014 the first thing you encounter before a fragrance settles into its deeper layers. It gives fragrances a sense of open space and altitude. Often paired with sage, vetiver, or smoke.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/v1777885536/hf_20260428_132627_ea358af3-7764-49ee-b5e3-4015e19ad4fe_cl3jch.png' },
      { name: 'Vetiver', desc: 'Roots pulled from dark earth. Something honest about it.', detail: 'It comes from the roots of a grass native to India, and the smell is unmistakably subterranean. You might know it from certain colognes or natural skincare. It smells like the earth itself rather than anything that grows from it. It makes fragrances feel like they were found rather than made. Large amount of perfume brands (from Chanel to Frederic Malle) have used it to create scents.\nIn perfumery vetiver is one of the most important base notes in existence. Its molecules are extremely heavy and slow to evaporate, which means it stays on skin for hours after everything else has gone. It grounds fragrances that might otherwise float away, and adds a raw, smoky depth that synthetic ingredients rarely replicate convincingly.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/v1777885580/hf_20260428_140455_e4acec14-5d2c-4118-a1a6-c4e5dda006a0_eowwiz.png' }
    ]
  },
  OUTOFTIME: {
    you: 'You are',
  ...
  SUMMER: {
    ...
    ingredients: [
      { name: 'Tiare', desc: 'A white flower in warm wind. Slightly sweet and fresh.', detail: 'Creamy, soft, and faintly exotic. Tiare is the flower used in monoi oil, which you might know from suncare products or hair oils with a Polynesian origin. It\'s a white flower that blooms in heat, and it smells exactly like that - summery, cozy and slightly sweet. It can quickly go from niche to mass market depending on supporting ingredients. Our must-try is "Heliodose" by Marlou.\nIn perfumery tiare is used to add a warm, tropical floral quality that doesn\'t feel heavy or overdone. Its molecules evaporate at medium speed, placing it in the heart of a fragrance where it adds a soft, sunny depth. It\'s one of the few florals that feels genuinely warm and not powdery. Often paired with coconut, citrus, other white flowers, or light musks.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/v1777885741/tiare1_xmotv4.png' },
      { name: 'Sea Salt', desc: 'Your skin an hour after swimming. Mineral and light.', detail: 'Clean, slightly bitter, and unmistakably coastal: the smell of skin that\'s been in the ocean and dried in the sun. You know it from the beach, from certain skincare products, from the air in a coastal town first thing in the morning. It makes fragrances feel like being somewhere rather than wearing something.\nIn perfumery sea salt is used to add a clean, sparkly feeling that is open and uncontained. Its molecules are light and volatile, making it a top note: the first impression of a fragrance before you smell other ingredients. It gives fragrances a sense of space and air that very few other ingredients can achieve. Often paired with milky, woody or flowery notes.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/v1777885744/sea-salt1_iwtvlx.png' },
      { name: 'Carrot Seed', desc: 'Warm, dry, and nothing like the vegetable.', detail: 'Earthy, slightly spicy, with a dry woody edge underneath. Carrot seed is extracted from the seeds of the wild carrot plant and smells nothing like the food. It\'s warmer and more complex than that. You might find it in natural skincare and aromatherapy oils \u2014 it\'s been used in both for centuries: warm without being heavy and spicy without being sharp. Carrot seed is used by LV, Tom Ford, Amouage, Prada, Kilian, Byredo, Nishane and many others.\nIn perfumery carrot seed is used to add a warm, slightly spicy depth that sits in the heart and base of a fragrance. It\'s the ingredient that makes summer feel like more than just a light day, it adds the warmth of a stone that\'s been in the sun all afternoon. Often paired with citrus, seeds, florals, or green notes.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/v1777885747/hf_20260428_131402_8546c5c2-655b-471f-b044-c0f7e4fdaa74_drbx9q.png' },
      { name: 'Grass', desc: 'The smell of summer.', detail: 'Slightly sweet, and immediately recognisable: freshly cut grass is one of the most universally known smells in the world. There\'s a freshness caused by the plant releasing compounds the moment it\'s cut. You\'ve smelled it your entire life. On skin it becomes cleaner and more abstract: less lawn, more open air. Hermes uses it for it\'s fresh scents.\nIn perfumery grass is used to add a fresh, green brightness that feels immediately like outdoors. Its molecules are light and volatile, making it a top note that evaporates quickly and doesn\'t stay on skin for very long. Often paired with light florals, citrus, fruity notes.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/v1777885751/hf_20260428_131409_f4c0d2a1-c968-49cc-900d-7fee2c9566c9_csz0mi.png' },
      { name: 'Cucumber', desc: 'Cool, watery, slightly green. The smell of something refreshing.', detail: 'Clean, faintly sweet, and almost transparent, like a sip of sparkling water on a hot day. The smell of cucumber is one of the most immediately refreshing things you can encounter. There\'s a watery quality to it that feels refreshing and cooling. You know it from skincare, from spa water, or even from slicing a cucumber on a hot afternoon. On skin it becomes even more subtle and barely present.\nIn perfumery cucumber is used to add a cool, watery freshness that sits very close to skin. Its molecules are light and evaporate quickly, making it a top note that stays not very long on the skin and creates an immediate impression of just getting out of shower before giving way to warmer ingredients. It\'s the ingredient that makes a fragrance feel like relief. Often paired with sea salt, grass, or light aquatics. Never sweet enough to be gourmand.', img: 'https://res.cloudinary.com/dcefrxxav/image/upload/v1777885753/hf_20260428_131017_162611d5-70ae-4e8e-b89f-dcfda00ddbc7_kt2ucz.png' }
    ]
  },
  THERAPIST: {
    you: 'You are',
...
function injectModalStyles() {
  ...
  style.textContent = '#fms-modal-overlay{display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.72);align-items:center;justify-content:center;padding:20px;box-sizing:border-box;}#fms-modal-overlay.fms-modal-open{display:flex;}#fms-modal-box{background:rgba(0,0,0,0.45);border:1px solid rgba(255,255,255,0.08);max-width:520px;width:100%;max-height:88vh;overflow-y:auto;border-radius:4px;position:relative;padding:0;}#fms-modal-close{position:absolute;top:16px;right:16px;background:none;border:none;color:rgba(255,255,255,0.5);font-size:20px;line-height:1;cursor:pointer;padding:4px 8px;z-index:2;transition:color 0.2s;}#fms-modal-close:hover{color:#fff;}#fms-modal-img{width:100%;height:240px;object-fit:cover;display:block;border-radius:4px 4px 0 0;}#fms-modal-body{padding:28px 28px 32px;}#fms-modal-name{font-size:22px;font-weight:600;color:#fff;letter-spacing:0.02em;margin:0 0 8px;}#fms-modal-phrase{font-size:13px;color:rgba(255,255,255,0.45);font-style:italic;margin:0 0 20px;line-height:1.5;}#fms-modal-detail{font-size:14px;color:rgba(255,255,255,0.72);line-height:1.75;white-space:pre-line;margin:0;}.fms-z2-title{font-size:clamp(22px,3.5vw,44px);font-weight:700;letter-spacing:0.04em;text-transform:uppercase;line-height:1;margin:0 0 16px;}.fms-z1-rule{border:none;border-top:1px solid #1a1a1a;opacity:0.15;margin:0 0 32px;}.fms-ingredient-item{display:flex;flex-direction:column;align-items:center;}.fms-ingredient-body{display:flex;flex-direction:column;flex:1;width:100%;}.fms-ingredient-desc{flex:1;}@media(max-width:767px){.fms-ingredient-item{flex-direction:row;gap:16px;padding:8px 0;}.fms-ingredient-img{order:2;flex-shrink:0;width:64px;height:64px;border-radius:50%;object-fit:cover;}.fms-ingredient-body{order:1;flex:1;}.fms-ingredient-readmore{align-self:flex-start;}}.fms-z5-cards{display:flex;gap:16px;margin-bottom:20px;}.fms-z5-card-wrap{flex:1;display:flex;flex-direction:column;gap:8px;}.fms-z5-card-canvas{width:100%;aspect-ratio:1;display:block;border-radius:2px;background:rgba(0,0,0,0.06);}.fms-z5-card-label{font-size:10px;letter-spacing:0.1em;text-transform:uppercase;opacity:0.4;text-align:center;}@media(max-width:600px){.fms-z5-cards{flex-direction:column;}}.fms-z5-email{margin-top:40px;padding:32px;background:rgba(0,0,0,0.45);border-radius:4px;}.fms-z5-email-title{font-family:HIGHCRUISER,"Arial Black",Arial,sans-serif;font-size:clamp(28px,4vw,48px);font-weight:400;color:#fff;letter-spacing:0.06em;text-transform:uppercase;margin-bottom:10px;line-height:1.1;}.fms-z5-email-sub{font-family:Inconsolata,monospace;font-size:39px;color:rgba(255,255,255,0.5);margin-bottom:24px;letter-spacing:0.04em;font-style:normal;}.fms-z5-email-row{display:flex;gap:12px;margin-bottom:16px;}.fms-z5-email-input{flex:1;padding:14px 18px;font-size:16px;border:1px solid rgba(255,255,255,0.15);border-radius:3px;background:rgba(255,255,255,0.07);color:#fff;outline:none;font-family:inherit;transition:border-color 0.2s;}.fms-z5-email-input::placeholder{color:rgba(255,255,255,0.3);}.fms-z5-email-input:focus{border-color:rgba(255,255,255,0.4);}.fms-z5-email-send{padding:14px 28px;background:#fff;color:#1a1a1a;border:none;border-radius:3px;font-size:13px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;cursor:pointer;white-space:nowrap;transition:opacity 0.2s;font-family:inherit;}.fms-z5-email-send:hover{opacity:0.85;}.fms-z5-email-send:disabled{opacity:0.4;cursor:default;}.fms-z5-email-consent{display:flex;align-items:flex-start;gap:10px;margin-bottom:14px;}.fms-z5-email-consent input[type=checkbox]{margin-top:3px;width:16px;height:16px;flex-shrink:0;cursor:pointer;accent-color:#fff;}.fms-z5-email-consent-label{font-size:12px;color:rgba(255,255,255,0.4);line-height:1.5;}.fms-z5-email-consent-label a{color:rgba(255,255,255,0.55);}.fms-z5-email-msg{font-size:13px;color:rgba(255,255,255,0.6);margin-top:8px;min-height:20px;}.fms-z5-email-msg.success{color:#7ec87e;}.fms-z5-email-msg.error{color:#e07070;}@media(max-width:500px){.fms-z5-email-row{flex-direction:column;}.fms-z5-email{padding:24px 20px;}}.fms-ingredient-readmore{display:inline-block;margin-top:auto;padding-top:12px;font-size:11px;letter-spacing:0.08em;text-transform:uppercase;color:#1a1a1a;background:none;border:none;border-bottom:1px solid #1a1a1a;padding-bottom:1px;cursor:pointer;transition:opacity 0.2s;align-self:center;}.fms-ingredient-readmore:hover{opacity:0.5;}';
...
// ============================================================
// SECTION 1B — PAGE BUILDER (unchanged)
// ============================================================
...
function buildBlock(key, arch) {
  ...
  if (arch.ingredients) {
    const itemsHTML = arch.ingredients.map(function(ing, idx) {
      return '<div class="fms-ingredient-item"><img class="fms-ingredient-img" src="' + ing.img + '" alt="' + ing.name + '"><div class="fms-ingredient-body"><div class="fms-ingredient-name">' + ing.name + '</div><div class="fms-ingredient-desc">' + ing.desc + '</div><button class="fms-ingredient-readmore" data-archetype="' + key + '" data-index="' + idx + '">Read more</button></div></div>';
    }).join('');
    ingredientsHTML = '<div class="fms-ingredients"><span class="fms-ingredients-label">ingredients worth discovering</span><div class="fms-ingredients-list">' + itemsHTML + '</div></div>';
  }
  ...
  z2a.innerHTML = '<div class="fms-z2-title" style="color:' + ac.titleColor + ';">YOUR SCENT PERSONALITY</div><hr class="fms-z1-rule" style="border-color:' + ac.ruleColor + ';opacity:0.3;"><div class="fms-z2-text">' + arch.desc.map(function(p) { return '<p style="color:' + ac.textColor + ';">' + p + '</p>'; }).join('') + '</div>';
  ...
  z3.innerHTML = '<img class="fms-z3-bottle" src="' + arch.main.img + '" alt="' + arch.main.name + '" crossorigin="anonymous"><div class="fms-z3-name">' + arch.main.name + '</div><div class="fms-z3-house">' + arch.main.house + '</div><div class="fms-z3-desc">' + arch.main.desc + '</div><a class="fms-z3-cta" href="' + arch.main.link + '" target="_blank" rel="noopener">discover \u2192</a>';
  ...
  const altsHTML = arch.alts.map(function(a) {
    return '<div class="fms-z4-item"><img class="fms-z4-img" src="' + a.img + '" alt="' + a.name + '" crossorigin="anonymous"><div class="fms-z4-info"><div class="fms-z4-name">' + a.name + '</div><div class="fms-z4-house">' + a.house + '</div><div class="fms-z4-tagline">' + a.desc + '</div></div><a class="fms-z4-discover" href="' + a.link + '" target="_blank" rel="noopener">discover \u2192</a></div>';
  }).join('');
  z4.innerHTML = '<span class="fms-z4-label">also consider</span><span class="fms-z4-sublabel">same energy, different character</span><div class="fms-z4-list">' + altsHTML + '</div>';
  block.appendChild(z4);

  // ZONE 5 — Email
  const z5 = document.createElement('div');
  z5.className = 'fms-zone fms-z5';
  z5.innerHTML = '<div class="fms-z5-email" id="fms-email-' + key + '"><div class="fms-z5-email-title">Want to keep this?</div><div class="fms-z5-email-sub">Your full archetype. The ingredients that chose you. One email, nothing else.</div><div class="fms-z5-email-row"><input class="fms-z5-email-input" id="fms-ei-' + key + '" type="email" placeholder="your@email.com"><button class="fms-z5-email-send" id="fms-es-' + key + '">Send my result</button></div><div class="fms-z5-email-consent"><input type="checkbox" id="fms-ec-' + key + '"><label class="fms-z5-email-consent-label" for="fms-ec-' + key + '">I agree to receive my quiz result by email. One email only, no marketing. <a href="/privacy-policy" target="_blank">Privacy policy</a>.</label></div><div class="fms-z5-email-msg" id="fms-em-' + key + '"></div></div>';
...
// ============================================================
// SECTION 1C — CMS OVERRIDE with S/R/P MATCHING
// ============================================================
...
function loadCMSPerfumes() {
  ...
  items.forEach(function(item) {
    ...
    const mainEl = item.querySelector('[data-main]');
    const sweetEl = item.querySelector('[data-sweet]');
    const rawEl = item.querySelector('[data-raw]');
    const projEl = item.querySelector('[data-proj]');
  ...
  Object.keys(byArchetype).forEach(function(key) {
    ...
    // Separate bottles that have S/R/P data from legacy ones
    ...
    if (srpBottles.length > 0 && userPrefs) {
      // ── S/R/P MATCHING ──
      // Compute Manhattan distance for each bottle
      ...
      // Sort: closest first. On tie, preserve original CMS order
      ...
      // ── FALLBACK: legacy [data-main] logic ──
